...
use slot_core::{account::AccountInfo, credentials::Credentials};
use slot_graphql::api::Client;
use slot_graphql::auth::{
    me::{ResponseData, Variables},
    Me,
};
use slot_utils::browser;
use slot_utils::server::LocalServer;
use slot_utils::vars;
...
enum CallbackError {
    ...
    #[error(transparent)]
    Client(#[from] slot_graphql::api::ClientError),
