...
use slot_graphql::paymaster::list_paymasters::PaymasterBudgetFeeUnit;
use slot_graphql::paymaster::list_paymasters::{ResponseData, Variables};
use slot_graphql::paymaster::ListPaymasters;
