...
use slot_graphql::deployments::deployment_logs::DeploymentService;
use slot_graphql::{api::Client, deployments::DeploymentLogs};
use slot_graphql::{deployments::deployment_logs::*, GraphQLQuery};
