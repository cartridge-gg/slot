...
use slot_graphql::team::team_invoices::{InvoiceOrder, Variables};
use slot_graphql::team::team_invoices::{InvoiceOrderField, OrderDirection};
use slot_graphql::team::TeamInvoices;
...
impl InvoicesArgs {
    pub async fn run(&self, team_name: String) -> Result<()> {
        ...
        let data: slot_graphql::team::team_invoices::ResponseData =
