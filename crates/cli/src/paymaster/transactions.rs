...
use slot_graphql::paymaster::paymaster_transactions;
use slot_graphql::paymaster::paymaster_transactions::{
    PaymasterTransactionFilter, PaymasterTransactionOrder,
};
use slot_graphql::paymaster::PaymasterTransactions;
...
impl TransactionArgs {
    pub async fn run(&self, paymaster_name: String) -> Result<()> {
        ...
        if transactions.is_empty() {
            println!(
                "\n📊 Paymaster Transactions for '{}' (Last {})",
                paymaster_name, self.last
            );
            println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
        ...
        let display_transactions: Vec<TransactionDisplay> = transactions
            ...
            .map(|t| TransactionDisplay {
                ...
                status: match t.status {
                    paymaster_transactions::ActivityStatus::COMPLETED => "SUCCESS".to_string(),
